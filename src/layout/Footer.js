...
const FollowIcon = () => (
  ...
  Courses = () => (
    <Fragment>
      <li>
        <Link href="/course-grid">كل الدورات</Link>
      </li>
      <li>
        <Link href="/course-details">التحليل الفني</Link>
      </li>
      <li>
        <Link href="/course-details">التحليل الفني</Link>
      </li>
  ...
  Resources = () => (
    <Fragment>
      ...
      <li>
        <Link href="/faqs">سياسة الاستخدام والخصوصية</Link>
      </li>
      <li>
  ...
  CopyRight = () => (
    <p>
      © {new Date().getFullYear()}. <Link href="/">تداول الحيتان</Link> جميع الحقوق محفوظة
    </p>
  ),
        ...
        <div className="row justify-content-between text-white pt-75">
          <div className="col-lg-3 col-sm-4">
            <div className="footer-widget about-widget">
              ...
              <h5 className="pt-5">تابعنا عبر منصاتنا</h5>
          ...
          <div className="col-lg-2 col-md-3 col-sm-4">
            <div className="footer-widget menu-widget">
              <h5 className="footer-title">الكورسات</h5>
              <ul>
                <Courses />
              </ul>
            </div>
          ...
          <div className="col-lg-2 col-md-3 col-sm-4">
            <div className="footer-widget menu-widget">
              <h5 className="footer-title">صفحات مهمة</h5>
              <ul>
                <Resources />
              </ul>
            </div>
            ...
            <div className="row">
              <div className="col-sm-6">
                <div className="footer-widget contact-info-widget">
                  <h5 className="footer-title">ابقى على تواصل</h5>
                  <ul>
                    <li>
                      <i className="fas fa-map-marker-alt" />55 الشارع الرئيسي ،
                      الكتلة الثانية ، نيو يورk
                    </li>
                    <li>
                    ...
                    <li>
                      <i className="far fa-clock" /> الأحد - الجمعة ،
                      <br /> 08 ص - 05 م
                    </li>
                  </ul>
                </div>
                ...
                <div className="footer-widget video-widget">
                  ...
                  <Link href="/course-grid">
                    <a className="read-more">
                      رؤية المزيد <i className="fas fa-arrow-right" />
                    </a>
                  </Link>
                </div>
              </div>
