              ...
              <div className="logo-outer d-lg-flex align-items-center">
                <div className="logo">
                  <Link href="/">
                    <a>
                      <img
                        src="assets/images/logos/tradinglogo.png"
                        alt="Logo"
                        title="Logo"
                      />
                    </a>
        ...
        <div className="header-upper">
          <div className="container-fluid clearfix">
            <div className="header-inner d-flex align-items-center justify-content-between">
              ...
              <button>
                  <Link href="/login">
                     <a  className="theme-btn ">تسجيل دخول </a>
                 </Link>
                  <Link href="/signup">
                    <a className="theme-btn style-two mr-2" >انشاء حساب </a>
                 </Link>
                ...
                {/* menu sidbar */}
                {/* <div className="menu-sidebar mr-5" onClick={() => sidebarOnclick()}>
                  <button>
                    <span className="icon-bar" />
                    <span className="icon-bar" />
                    <span className="icon-bar" />
